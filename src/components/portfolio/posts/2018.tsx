			...
			},
			{
				...
				content: (
					<Fragment>
						...
						your snake grows larger. The goal is to survive as long as you can without running into
						your tail. After losing, the score, snake length, and chosen speed is saved to the
						leaderboards.
					</Fragment>
				)
			},
		...
		posts: [
			{
				...
				content: (
					<Fragment>
						It was a personal development project: learning more about how Artificial intelligence
						works. My goal was to fully understand and write code from the ground up without using
						existing libraries. Below you can find some projects I worked on using Machine Learning
						algorithms. <br />
			...
			},
			{
				...
				content: (
					<Fragment>
						...
						favorite 2, new ones are generated based on the previous bests.
					</Fragment>
				)
			},
			{
				...
				content: (
					<Fragment>
						...
						far as possible. As shown on the picture, a car recieves distance inputs. It scans how
						far a wall is at all 8 directions and decides where to move next.
					</Fragment>
				)
			},
			{
				...
				content: (
					<Fragment>
						...
						balls get the input of how far and how high is the obstacle, and how fast is it moving.
						Each of them have a unique set of arrows that help them decide whether they should jump
						or not. After all 100 balls are dead (hit a wall), a new, better generation of 100 new
						balls is made based & mutated off the best balls in the previous generation.
					</Fragment>
				)
			},
			{
		...
		posts: [
			{
				...
				content: (
					<Fragment>
						...
						renderer EJS that creates the HTML page. Once done it's sent to the user.
					</Fragment>
				)
			},
			{
