...
class LivePreviews extends Component {
  state = {
    previews: [
      ...
      { name: 'jumping balls NE', desc: 'Jumping balls that learn over time how to jump over the obstacles', picSrc: '/assets/pics/live-previews/jumping-balls.png', url: urls.external.livePreviews.jumpingBalls}
    ]
  }
  render() {
